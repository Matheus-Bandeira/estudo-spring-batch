...
public class ClienteTransacaoLineMapperConfig {
	...
	public PatternMatchingCompositeLineMapper lineMapper() {
		...
		lineMapper.setFieldSetMappers(filldSetMappers());
		return lineMapper;
	}
	
	@SuppressWarnings("rawtypes")
	private Map filldSetMappers() {
		Map<String, FieldSetMapper> fildSetMappers = new HashMap<>();
		fildSetMappers.put("0*", fieldSetMapper(Cliente.class));
		fildSetMappers.put("1*", fieldSetMapper(Transacao.class));
		return fildSetMappers;
	}
